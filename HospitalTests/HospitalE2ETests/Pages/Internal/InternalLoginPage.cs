...
namespace HospitalTests.HospitalE2ETests.Pages.Public
{
    public class InternalLoginPage
    {
        ...
        private IWebElement UsernameElement => _driver.FindElement(By.CssSelector("input[name='username']"));
        private IWebElement PasswordElement => _driver.FindElement(By.CssSelector("input[name='password']"));
        private IWebElement SubmitButtonElement => _driver.FindElement(By.Name("submit"));

        public InternalLoginPage(IWebDriver driver)
        {
            _driver = driver;
        }
