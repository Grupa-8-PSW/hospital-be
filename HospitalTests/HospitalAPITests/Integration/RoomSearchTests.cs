...
namespace HospitalTests.HospitalAPITests.Integration
{
    public class RoomSearchTests : BaseIntegrationTest
    {
        ...
        public void Searches_all_rooms_with_empty_string()
        {
            ...
            var result = ((OkObjectResult)controller.Search("", null))?.Value as List<RoomDTO>;
        ...
        public void Searches_equipment_formtated()
        {
            ...
            var result = ((OkObjectResult)controller.Search(" krevet ", null))?.Value as List<RoomDTO>;
        ...
        [Fact]
        public void Searches_equipment_formtated_amount()
        {
            using var scope = Factory.Services.CreateScope();
            var controller = SetupController(scope);

            var result = ((OkObjectResult)controller.Search(" krevet ", 3))?.Value as List<RoomDTO>;
