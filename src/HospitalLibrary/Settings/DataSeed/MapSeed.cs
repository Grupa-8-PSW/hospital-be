    ...
    public static class MapSeed
    {
        public static void SeedMap(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Room>().HasData(
                new Room() { Id = 1, X = 0, Y = 0, Width = 260, Height = 160, Color = "blue", Number = "101", Name = "Neurohirurgija", FloorId = 1, Type = RoomType.OPERATIONS },
                new Room() { Id = 2, X = 0, Y = 338, Width = 220, Height = 140, Color = "blue", Number = "102", Name = "Kafeterija", FloorId = 1, Type = RoomType.CAFETERIA },
                new Room() { Id = 3, X = 237, Y = 0, Width = 300, Height = 180, Color = "blue", Number = "103", Name = "Otorinolaringologija", FloorId = 1 , Type = RoomType.OTHER},
                new Room() { Id = 4, X = 270, Y = 378, Width = 200, Height = 100, Color = "blue", Number = "201", Name = "Fizioterapeut", FloorId = 2 , Type = RoomType.OTHER },
                new Room() { Id = 5, X = 0, Y = 0, Width = 360, Height = 180, Color = "blue", Number = "202", Name = "Stomatologija", FloorId = 2 , Type = RoomType.OTHER },
                new Room() { Id = 6, X = 0, Y = 0, Width = 260, Height = 180, Color = "blue", Number = "301", Name = "Magacin", FloorId = 3 , Type = RoomType.MAGAZINE },
                new Room() { Id = 7, X = 0, Y = 338, Width = 220, Height = 140, Color = "blue", Number = "302", Name = "Opsta nega", FloorId = 3, Type = RoomType.OTHER },
                new Room() { Id = 8, X = 330, Y = 158, Width = 220, Height = 140, Color = "blue", Number = "303", Name = "Cekaonica", FloorId = 3, Type = RoomType.OTHER },
                new Room() { Id = 9, X = 0, Y = 0, Width = 320, Height = 170, Color = "blue", Number = "101a", Name = "Kardiologija", FloorId = 4, Type = RoomType.OPERATIONS },
                new Room() { Id = 10, X = 0, Y = 365, Width = 220, Height = 140, Color = "blue", Number = "102a", Name = "Vaskularne bolesti", FloorId = 4, Type = RoomType.OTHER },
                new Room() { Id = 11, X = 245, Y = 0, Width = 220, Height = 140, Color = "blue", Number = "103a", Name = "Hirurgija", FloorId = 4 , Type = RoomType.OPERATIONS },
                new Room() { Id = 12, X = 0, Y = 0, Width = 220, Height = 140, Color = "blue", Number = "201a", Name = "Papirologija", FloorId = 5 , Type = RoomType.OTHER },
                new Room() { Id = 13, X = 200, Y = 0, Width = 220, Height = 140, Color = "blue", Number = "202a", Name = "Prijavna soba", FloorId = 5 , Type = RoomType.OTHER },
                new Room() { Id = 14, X = 0, Y = 350, Width = 220, Height = 140, Color = "blue", Number = "203a", Name = "Uplasta/isplata", FloorId = 5 , Type = RoomType.OTHER},
                new Room() { Id = 15, X = 200, Y = 350, Width = 220, Height = 140, Color = "blue", Number = "204a", Name = "Izgubljeno/nadjeno", FloorId = 5, Type= RoomType.OTHER},
                new Room() { Id = 16, X = 0, Y = 0, Width = 320, Height = 190, Color = "blue", Number = "101b", Name = "Onkologija", FloorId = 6, Type = RoomType.OTHER },
                new Room() { Id = 17, X = 200, Y = 300, Width = 250, Height = 240, Color = "blue", Number = "102b", Name = "Endokrinologija", FloorId = 6 , Type = RoomType.OPERATIONS},
                new Room() { Id = 18, X = 50, Y = 100, Width = 420, Height = 280, Color = "blue", Number = "201b", Name = "Gastronomija", FloorId = 7, Type = RoomType.OTHER },
                new Room() { Id = 19, X = 100, Y = 138, Width = 320, Height = 170, Color = "blue", Number = "301b", Name = "Magacin", FloorId = 8, Type = RoomType.MAGAZINE }
            );*/

            modelBuilder.Entity<Room>(r =>
            {
                r.HasData(
                    new Room() { Id = 1, Number = "101", Name = "Neurohirurgija", FloorId = 1, Type = RoomType.OPERATIONS },
                    new Room() { Id = 2, Number = "102", Name = "Kafeterija", FloorId = 1, Type = RoomType.CAFETERIA },
                    new Room() { Id = 3, Number = "103", Name = "Otorinolaringologija", FloorId = 1, Type = RoomType.OTHER },
                    new Room() { Id = 4, Number = "201", Name = "Fizioterapeut", FloorId = 2, Type = RoomType.OTHER },
                    new Room() { Id = 5, Number = "202", Name = "Stomatologija", FloorId = 2, Type = RoomType.OTHER },
                    new Room() { Id = 6, Number = "301", Name = "Magacin", FloorId = 3, Type = RoomType.MAGAZINE },
                    new Room() { Id = 7, Number = "302", Name = "Opsta nega", FloorId = 3, Type = RoomType.OTHER },
                    new Room() { Id = 8, Number = "303", Name = "Cekaonica", FloorId = 3, Type = RoomType.OTHER },
                    new Room() { Id = 9, Number = "101a", Name = "Kardiologija", FloorId = 4, Type = RoomType.OPERATIONS },
                    new Room() { Id = 10, Number = "102a", Name = "Vaskularne bolesti", FloorId = 4, Type = RoomType.OTHER },
                    new Room() { Id = 11, Number = "103a", Name = "Hirurgija", FloorId = 4, Type = RoomType.OPERATIONS },
                    new Room() { Id = 12, Number = "201a", Name = "Papirologija", FloorId = 5, Type = RoomType.OTHER },
                    new Room() { Id = 13, Number = "202a", Name = "Prijavna soba", FloorId = 5, Type = RoomType.OTHER },
                    new Room() { Id = 14, Number = "203a", Name = "Uplasta/isplata", FloorId = 5, Type = RoomType.OTHER },
                    new Room() { Id = 15, Number = "204a", Name = "Izgubljeno/nadjeno", FloorId = 5, Type = RoomType.OTHER },
                    new Room() { Id = 16, Number = "101b", Name = "Onkologija", FloorId = 6, Type = RoomType.OTHER },
                    new Room() { Id = 17, Number = "102b", Name = "Endokrinologija", FloorId = 6, Type = RoomType.OPERATIONS },
                    new Room() { Id = 18, Number = "201b", Name = "Gastronomija", FloorId = 7, Type = RoomType.OTHER },
                    new Room() { Id = 19, Number = "301b", Name = "Magacin", FloorId = 8, Type = RoomType.MAGAZINE }
                    );
