    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, 1, "abc", new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6732), 1, "reason1", 1, new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6732) },
                    { 2, false, 2, "abc", new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6735), 2, "reason2", 1, new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6735) },
                    { 3, false, 4, "abc", new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6737), 3, "reason3", 2, new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6736) },
                    { 4, true, 1, "abc", null, 1, "reason1", 1, new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6737) },
                    { 5, true, 2, "abc", null, 2, "reason2", 1, new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6738) },
                    { 6, true, 4, "abc", null, 3, "reason3", 2, new DateTime(2022, 11, 23, 22, 55, 24, 571, DateTimeKind.Utc).AddTicks(6739) }
                });
