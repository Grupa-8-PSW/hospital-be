            ...
            modelBuilder.Entity("HospitalLibrary.Core.Model.Examination", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PatientId = 1,
                            RoomId = 1,
                            StartTime = new DateTime(2022, 11, 22, 10, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            PatientId = 2,
                            RoomId = 2,
                            StartTime = new DateTime(2022, 11, 21, 12, 30, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            PatientId = 3,
                            RoomId = 1,
                            StartTime = new DateTime(2022, 11, 23, 4, 30, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            PatientId = 4,
                            RoomId = 2,
                            StartTime = new DateTime(2022, 11, 21, 5, 30, 0, 0, DateTimeKind.Utc)
                        });
                });
