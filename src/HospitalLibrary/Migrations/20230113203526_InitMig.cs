    ...
    public partial class InitMig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 0, "peraperic@gmail.com", "Pera", 0, "Peric", "2201000120492", 1, 2 },
                    { 2, 2, 7, "markomarkovic@gmail.com", "Marko", 0, "Markovic", "1412995012451", 2, 3 },
                    { 3, 3, 5, "dusanbaljinac@gmail.com", "Dusan", 0, "Baljinac", "2008004124293", 1, 4 },
                    { 4, 4, 3, "slobodanradulovic@gmail.com", "Slobodan", 0, "Radulovic", "1111978020204", 2, 5 }
                });

            migrationBuilder.InsertData(
                table: "Examinations",
                columns: new[] { "Id", "DoctorId", "Duration", "PatientId", "RoomId", "StartTime" },
                values: new object[] { 1, 1, 20, 1, 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3572) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, 1, "abc", new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3437), 1, "reason1", 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3436) },
                    { 2, false, 2, "abc", new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3446), 2, "reason2", 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3445) },
                    { 3, false, 4, "abc", new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3447), 3, "reason3", 2, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3447) },
                    { 4, true, 1, "abc", null, 1, "reason1", 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3448) },
                    { 5, true, 2, "abc", null, 2, "reason2", 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3449) },
                    { 6, true, 4, "abc", null, 3, "reason3", 2, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3451) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Headache", "Bromazepam 500mg", 0, 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3520) },
                    { 2, 1, 2, "Blood loss", "A+ 500ml", 1, 1, new DateTime(2023, 1, 13, 20, 35, 26, 376, DateTimeKind.Utc).AddTicks(3522) }
                });
