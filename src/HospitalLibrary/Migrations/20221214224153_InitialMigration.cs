    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, 1, "abc", new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1424), 1, "reason1", 1, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1423) },
                    { 2, false, 2, "abc", new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1430), 2, "reason2", 1, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1429) },
                    { 3, false, 4, "abc", new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1432), 3, "reason3", 2, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1431) },
                    { 4, true, 1, "abc", null, 1, "reason1", 1, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1433) },
                    { 5, true, 2, "abc", null, 2, "reason2", 1, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1435) },
                    { 6, true, 4, "abc", null, 3, "reason3", 2, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1436) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Headache", "Bromazepam 500mg", 0, 1, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1494) },
                    { 2, 1, 2, "Blood loss", "A+ 500ml", 1, 1, new DateTime(2022, 12, 14, 22, 41, 52, 454, DateTimeKind.Utc).AddTicks(1497) }
                });
