    ...
    public partial class InitialMigraton : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, 1, "abc", new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9820), 1, "reason1", 1, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9819) },
                    { 2, false, 2, "abc", new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9823), 2, "reason2", 1, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9823) },
                    { 3, false, 4, "abc", new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9825), 3, "reason3", 2, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9824) },
                    { 4, true, 1, "abc", null, 1, "reason1", 1, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9825) },
                    { 5, true, 2, "abc", null, 2, "reason2", 1, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9826) },
                    { 6, true, 4, "abc", null, 3, "reason3", 2, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9827) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Headache", "Bromazepam 500mg", 0, 1, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9859) },
                    { 2, 1, 2, "Blood loss", "A+ 500ml", 1, 1, new DateTime(2022, 12, 14, 21, 51, 8, 239, DateTimeKind.Utc).AddTicks(9860) }
                });
