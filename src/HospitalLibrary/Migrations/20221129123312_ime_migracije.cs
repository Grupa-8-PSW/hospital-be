    ...
    public partial class ime_migracije : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, 1, "abc", new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4736), 1, "reason1", 1, new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4734) },
                    { 2, false, 2, "abc", new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4744), 2, "reason2", 1, new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4743) },
                    { 3, false, 4, "abc", new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4747), 3, "reason3", 2, new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4746) },
                    { 4, true, 1, "abc", null, 1, "reason1", 1, new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4750) },
                    { 5, true, 2, "abc", null, 2, "reason2", 1, new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4752) },
                    { 6, true, 4, "abc", null, 3, "reason3", 2, new DateTime(2022, 11, 29, 12, 33, 11, 154, DateTimeKind.Utc).AddTicks(4754) }
                });
